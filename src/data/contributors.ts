    ...
    resolved_issues: [
      {
        ...
        description:
          "Built the core pipeline to ingest and normalize external threat feeds in real-time.",
      ...
      },
      {
        ...
        description:
          "Engineered a JS-based PDF generation pipeline for 1-click legal takedown notices.",
    ...
    resolved_issues: [
      {
        ...
        description:
          "Created the sleek, high-end dark mode UI for the Concierge Threat Dashboard.",
      ...
      },
      {
        ...
        description:
          "Optimized React Suspense boundaries and injected JSON-LD schema for AI ranking.",
